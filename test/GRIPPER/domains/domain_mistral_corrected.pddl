...
(define (domain mydomain)
  ...
  (:action pick
    ...
    :precondition (and (at ?r ?l) (has-gripper ?r ?g) (in-room ?o ?l) (is-broken ?o) (not (is-fixed ?o)) (not (is-busy ?r)) (not (is-active ?g)) (not (holding ?g ?o)))
    :effect (and (holding ?g ?o) (is-active ?g) (is-busy ?r))
  )

  (:action drop
    :parameters (?r - robot ?g - gripper ?o - object ?l - room)
    :precondition (and (at ?r ?l) (has-gripper ?r ?g) (holding