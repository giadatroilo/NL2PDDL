...
(:action load-to-crane
  :parameters (?r - robot ?c - container ?cr - crane ?l - location)
  :precondition (and (at-location ?r ?l) (at-location ?cr ?l) (is-carrying ?r ?c) (is-operational ?cr) (not (is-lifting ?cr ?c)))
  :effect (and (not (is-carrying ?r ?c)) (is-empty ?r) (is-lifting ?cr ?c) (not (is-loaded ?c)) (is-unloaded ?c) (at-location ?c ?l))
))
